    ...
    class TraceAdsSymbol
    {
        ...
        private void SamplestoString()
        {
            try
            {
                ...
                int Count = _listsamples1.Count > _listsamples2.Count ? _listsamples1.Count : _listsamples2.Count;
                ...
                for (i = 0; i < (Count - 1); i++)
                {
                    ...
                    //short value1 = Convert.ToInt16(_listsamples3[i].value.ToString());
                    //if (value1 == 520 || value1 == 530 || value1 == 535 || value1 == 540 || value1 == 545 || value1 == 550)
                    //{
                    j++;
                    ...
                    this._stringbuilder.AppendLine( _listsamples1[i].value.ToString() + ";" +
                                                    _listsamples2[i].value.ToString() + ";" + 
                                                    _listsamples3[i].value.ToString());
                    //}
                }
            }
            catch (Exception ex)
